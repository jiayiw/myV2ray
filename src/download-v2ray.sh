_get_latest_version() {
	v2ray_latest_ver="$(curl -H 'Cache-Control: no-cache' -s https://api.github.com/repos/jeffrey82/core/releases/latest | grep 'tag_name' | cut -d\" -f4)"
...
_download_v2ray_file() {
	...
	v2ray_download_link="https://github.com/jeffrey82/core/releases/download/$v2ray_latest_ver/v2ray-linux-${v2ray_bit}.zip"
